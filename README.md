...
| **[APP_DESIGN_GUIDELINES.md](APP_DESIGN_GUIDELINES.md)** | Anti-vibecode desktop standards, native Windows UX rules, Segoe UI design system, and visual review gates. |
